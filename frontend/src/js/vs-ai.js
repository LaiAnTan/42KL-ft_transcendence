...
<div class="d-flex flex-row justify-content-between unselectable" style="height: 92vh; padding: 100px 10%">
	<div class="d-flex flex-column rounded-border w-45 p-3 mr-1" style="min-width: 500px; min-height: 600px;">
	...
	<div class="d-flex flex-column justify-content-between w-45 ml-1" style="min-width: 500px; min-height: 600px;">
